...
let creatureName = "Griffin";


// 2. Declare a variable named 'creatureDescription' and describe its magical properties as a string.
let creatureDescription = "a creature with a lions body and wings and birds head usually a eagles";
...
let zooSummary = "The " + creatureName + " is a " + creatureDescription + ". It is " + isFriendly + " that it is friendly and it is " + visitorAge + " years old. It is " + canVisit + " that the visitor is allowed to see the " + creatureName + ".
